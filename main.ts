...
function Make_Tree () {
    Tree = sprites.create(img`
        ...
        bbbbbbbbbbbbbbbb
        `, SpriteKind.Tree)
    Tree.setPosition(scene.screenWidth(), randint(20, 100))
    Tree.vx = Velocity
    Tree.setFlag(SpriteFlag.AutoDestroy, true)
    Tree_Background = sprites.create(img`
        dddddddddddddddd
        dddddddddddddddd
        dddddddddddddddd
        dddddddddddddddd
        ...
        dddddddddddddddd
        dddddddddddddddd
        `, SpriteKind.TreeBackground)
    Tree_Background.setPosition(scene.screenWidth(), 0)
...
function Health_Bar () {
    ...
    statusbar.attachToSprite(HealthBar)
...
forever(function () {
    Velocity = -50 - Score
    scroller.scrollBackgroundWithSpeed(Velocity, 0)
})
